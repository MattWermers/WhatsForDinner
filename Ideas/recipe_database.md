...
- **SQL Server**
    - Insert recipes into a SQL database
        - Schema
            ...
            *table_ingredients*         | ingredient_id     | ingredient_name   | volume_flag               | weight_flag (these indicate how ingredient is measured)
            *table_measurements*        | measurement_id    | unit_name         | type (ie. volume, weight)
            *im_ingredient_measurement* | im_id             | ingredient_id     | measurement_id |          | quantity (count)
