...
This week, the `WEEKLY_STATUS` documentation template was established, and the team continued researching Flask in preparation for migrating the application. Overall progress during Week 08 was lighter than expected due to time spent completing the individual Lab 7 assignment.
 ...
 <summary>Completed Tasks</summary>
  ...
  <details>
   <summary>Zeke</summary>
    <ul>
     <li>Created `template_WEEKLY_STATUS.md`.</li>
    </ul>
  </details>
  <details>
...
<ul>
 ...
 <li>Zeke will upload week_08_WEEKLY_STATUS.md to the repo. 07/08.</li>
