...
Board\](https://trello.com/invite/b/6a30b02f9664f0fdedf05352/ATTIf1f6a87882645f7393bd5a92c95331b6FC048ACE/3308-team-6)  
\- Version control repository (instructors have access): \[GitHub  
Repo\](https://github.com/MattWermers/WhatsForDinner)  
...
- WEEKLY\_STATUS.md (docs/weekly-status/)  
- PAGE\_TESTING.md (docs/testing/)  
- SQL\_TESTING.md (docs/testing/)  
- FINAL\_REPORT.md  
- Project presentation files from Milestone 7 (WhatsForDinner\_demo.pdf, link to video in README)  
- Source code  
- Test cases  
...
- Not an init search (cannot negatively select ingredients before inti search)  
